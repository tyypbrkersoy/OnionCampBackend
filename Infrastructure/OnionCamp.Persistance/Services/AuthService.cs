...
namespace OnionCamp.Persistance.Services
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(IHttpClientFactory httpClientFactory, IConfiguration configuration, UserManager<A.AppUser> userManager, ITokenHandler tokenHandler, SignInManager<A.AppUser> signInManager, IUserService userService)
        {
        ...
        async Task<Token> CreateUserExternalAsync(A.AppUser user, string email, string name, UserLoginInfo info, int accessTokenLifeTime)
        {
